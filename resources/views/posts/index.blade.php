...
<table class=" mx-auto shadow my-5 rounded-3">
    ...
    <tr class="bg-dark text-white border">
        ...
        <th class="border p-2 text-center">Publish At</th>
    ...
    <tr class="border">
        ...
        <td class="border p-2 text-center d-flex"><a class="btn btn-info me-2" href="/posts/{{$post->id}}">Show</a><a class="btn btn-info me-2" href="/posts/{{$post->id}}/edit">Edit</a><form action="{{url("posts/$post->id")}}" method="post"><input class="btn btn-danger" value="Delete" type="submit">@csrf @method("delete")</form></td>
    </tr>
    @endforeach
</table>
@endsection
